...
> Lundi revu, Crunchs → Dead bug vendredi, mobilité samedi.
...
DO $$
DECLARE
  d_lundi UUID; d_vendredi UUID; d_samedi UUID;
  bar_ez UUID; bar_droite UUID; bar_haltere UUID;
BEGIN
  ...
  -- Lundi : nouveau programme dos + biceps
  ...
  INSERT INTO exercises (program_day_id, name, order_index, sets_target, reps_target, is_bodyweight, notes, section, bar_id) VALUES
    ...
    (d_lundi, 'Curl haltère concentré',              9, 2, '12-15',  false, 'Coude calé sur intérieur de cuisse, contraction max en haut, 2s de hold',                                 'main', bar_haltere),
  ...
  -- Samedi : supprimer cardio block, ajouter mobilité
...
## 9. Migration 008 — Dead bug mercredi (activation avant SDT)
